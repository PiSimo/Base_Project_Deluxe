...
# Parameters
tube_radius = 50        # Radius of the airway tube
tube_length = 200        # Length of the tube
alveolus_radius = 150
overlap_factor = 0.8
...
def generate_bottomup_model():
    ...
    gmsh.write("../input/mesh/alveolar_sac_mesh.msh")
    gmsh.write("../input/mesh/alveolar_sac_mesh.stl")
    gmsh.finalize()
